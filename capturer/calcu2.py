...
for x in range(10):
    acciones[x] = aportaciones[x]/valoracion2015[x]
    valor2015[x]=acciones[x]*valoracion2015[x]
    valor2016[x]=acciones[x]*valoracion2016[x]
    valor2017[x]=acciones[x]*valoracion2017[x]
    valor2018[x]=acciones[x]*valoracion2018[x]
